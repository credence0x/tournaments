...
pub impl ContractAddressDefaultImpl of Default<ContractAddress> {
    fn default() -> ContractAddress {
        Zero::zero()
    }
}

pub impl SpanU64DefaultImpl of Default<Span<u64>> {
    fn default() -> Span<u64> {
        array![].span()
    }
}
...
#[derive(Copy, Drop, Serde, Default, Introspect, DojoStore)]
